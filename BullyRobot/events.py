...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import BullyRobot.events

        path = Path(f"BullyRobot/modules/{shortname}.py")
        name = "BullyRobot.modules.{}".format(shortname)
        ...
        mod.BullyRobot = BullyRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["BullyRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "BullyRobot/modules/*.py"
