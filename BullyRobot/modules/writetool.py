...
from BullyRobot import pbot as bully, dispatcher, SUPPORT_CHAT


@bully.on_message(filters.command("write"))
async def handwrite(_, message: Message):
  if not message.reply_to_message:  
    text = message.text.split(None, 1)[1]
    m = await bully.send_message(message.chat.id, "**ᴩʟᴇᴀsᴇ ᴡᴀɪᴛ...**\n\nʟᴇᴍᴍᴇ ᴡʀɪᴛᴇ ɪᴛ ᴏɴ ᴍʏ ᴄᴏᴩʏ...")
...
"""    
    await m.delete()
    await bully.send_photo(message.chat.id, photo=photo, caption=caption,
